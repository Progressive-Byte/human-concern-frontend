      ...
      <div className="relative w-full overflow-hidden pt-[120px] lg:pt-[160px] pb-16">
        ...
        <div className="relative z-20 flex items-center justify-center px-4 sm:px-8">
          <div className="relative w-full max-w-[1100px] flex items-center justify-center min-h-[540px]">
            ...
            <div className="relative z-20 ml-auto w-[62%] md:w-[58%] bg-white rounded-[24px] shadow-[0_8px_60px_rgba(0,0,0,0.12)] px-8 sm:px-10 py-10 flex flex-col items-center text-center">
