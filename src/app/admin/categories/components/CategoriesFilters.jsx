export default function CategoriesFilters({ q, status, onChangeQ, onChangeStatus }) {
  return (
    <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
      ...
      <select
        ...
        className="w-full md:w-[180px] rounded-xl border border-dashed border-[#E5E7EB] bg-white px-3 py-3 text-[13px] text-[#111827] outline-none transition focus:border-[#111827]/30"
      >
