...
function getConfirmCopy(action) {
  if (action === "archive") return { title: "Archive cause?", description: "Archived causes are removed from active use.", confirmText: "Archive" };
  if (action === "restore") return { title: "Restore cause?", description: "This will restore the cause from archived state.", confirmText: "Restore" };
