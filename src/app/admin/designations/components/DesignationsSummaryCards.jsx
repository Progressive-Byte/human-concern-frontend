...
const DesignationsSummaryCards = ({ summary, loading }) => {
  const s = summary || {};
  ...
  return (
    <section className="grid grid-cols-1 gap-4 md:grid-cols-3">
      {loading ? (
        ...
        <>
          <KpiCard label="Total Designations" value={Number(s.total || 0)} icon={<TagIcon />} iconPosition="left" />
...
export default DesignationsSummaryCards;
