...
function getConfirmCopy(action) {
  if (action === "archive") {
    return {
      ...
      description: "Archived designations are removed from active use.",
      confirmText: "Archive",
    };
  }
  if (action === "restore") {
    return {
      ...
      description: "This will restore the designation from archived state.",
      confirmText: "Restore",
    };
  }
...
const DesignationRowActions = ({ item, onEdit, onArchive, onRestore }) => {
