...
function getConfirmCopy(action) {
  if (action === "archive") return { title: "Archive add-on?", description: "Archived add-ons are removed from active use.", confirmText: "Archive" };
  if (action === "restore") return { title: "Restore add-on?", description: "This will restore the add-on from archived state.", confirmText: "Restore" };
