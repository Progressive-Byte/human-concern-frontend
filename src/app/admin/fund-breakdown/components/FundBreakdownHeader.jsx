...
const FundBreakdownHeader = ({ onExport, onRefresh, refreshing = false, exporting = false }) => {
  const { admin } = useAdminAuth();

  return (
    <div className="hc-animate-fade-up flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
      <div>
        <h1 className="text-[24px] font-semibold leading-tight text-[#111827]">Fund Breakdown</h1>
