...
const PAGE_WRAP = "flex items-center justify-between gap-3 border-t border-[#F3F4F6] px-5 py-4";

const FundBreakdownPagination = ({ pagination, onPrev, onNext }) => {
  ...
  return (
    <div className={PAGE_WRAP}>
      <div className="text-[13px] text-[#6B7280]">
        Showing {shown} of {total || shown} funds
      </div>
...
export default FundBreakdownPagination;
