  ...
  return (
    <div className="hc-animate-fade-up flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
      <div className="flex-1">
        <div className="flex items-center gap-2 rounded-xl border border-[#E5E7EB] bg-white px-3 py-2.5 focus-within:border-red-500/40">
      ...
      <div className="w-full md:w-[180px]">
        <div className="rounded-xl border border-[#E5E7EB] bg-white px-3 py-2.5 focus-within:border-red-500/40">
          <select
            value={status}
