...
export default function ObjectivesHeader({ onCreate }) {
  ...
  return (
    <div className="hc-animate-fade-up flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
      <div>
        <h1 className="text-[24px] font-semibold leading-tight text-[#111827]">Objectives</h1>
        <p className="mt-1 text-[14px] text-[#6B7280]">Create and manage donation objectives</p>
      </div>
