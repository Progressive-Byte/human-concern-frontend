          ...
          return (
            ...
            >
                ...
                <div className="flex-1 min-w-0 flex items-start justify-between gap-3">
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center flex-wrap gap-1.5">
                      <h3 className="font-semibold text-[#111827] text-sm md:text-base leading-snug">
                        {s.title}
                      </h3>
                      <span
                      ...
                      >
                        <span
                          className={`w-1.5 h-1.5 rounded-full ${
                            isActive ? "bg-[#047857] animate-pulse" : "bg-[#B45309]"
                          }`}
                        />
                        {s.status}
                      </span>
                  ...
                  <div className="shrink-0 flex items-center gap-2 md:gap-3">
                    <div className="text-right">
                      <p className="text-xl md:text-2xl font-bold text-[#EA3335] leading-none">
                        ${s.amount}
                      </p>
              ...
              <div className="mt-3 pt-3 border-t border-[#E5E7EB] flex flex-wrap items-center gap-x-5 gap-y-1.5 text-xs text-[#6B7280]">
                ...
                <span>
                  Total donated:&nbsp;
                  <span className="font-semibold text-[#111827]">${s.totalDonated}</span>
                </span>
              </div>
            </div>
          );
